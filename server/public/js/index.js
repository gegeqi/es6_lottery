...
var _caculate = __webpack_require__(332);
...
var Lottery = function (_mix) {
    ...
    return Lottery;
}(mix(_base2.default, _caculate2.default, _interface2.default, _timer2.default));
    ...
    _createClass(Base, [{
        ...
        value: function initPlayList() {
            this.play_list.set('r2', {
                ...
                bonus: 19,
                tip: '从0~11中任选3个或多个号码,所选号码与开奖号码任意三个个号码相同,即中奖<em class="red">19</em>元',
                name: '任三'
            }).set('r4', {
                bonus: 78,
                ...
                bonus: 540,
                tip: '从0~11中任选5个或多个号码,所选号码与开奖号码相同,即中奖<em class="red">540</em>元',
                name: '任五'
            }).set('r6', {
                bonus: 90,
                tip: '从0~11中任选6个或多个号码,所选号码与开奖号码五个号码相同,即中奖<em class="red">90</em>元',
                name: '任六'
            }).set('r7', {
                bonus: 26,
                tip: '从0~11中任选7个或多个号码,所选号码与开奖号码五个号码相同,即中奖<em class="red">26</em>元',
                name: '任七'
            }).set('r8', {
                bonus: 9,
                tip: '从0~11中任选8个或多个号码,所选号码与开奖号码五个号码相同,即中奖<em class="red">9</em>元',
                name: '任八'
            });
        }
        ...
        value: function getCount() {
            ...
            if (count === 0) {
                ...
                tpl = '\u60A8\u9009\u4E86 <b>' + count + '</b>\u6CE8\uFF0C\u5171 <b>' + count * 2 + '</b> \u5143  <em>\u82E5\u4E2D\u5956\uFF0C\u5956\u91D1\uFF1A\n                <strong class="red">' + range[0] + '</strong> \u5143 \u81F3 <strong class="red">' + range[1] + '</strong>\uFF0C\n                \u60A8\u5C06' + (win1 >= 0 ? '盈利' : '亏损') + '\n                <strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + c1 + '</strong> \u5143</em> \u81F3 <strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + c2 + '</strong> \u5143</em>';
            }
    ...
    _createClass(Caculate, [{
        ...
        value: function computeCount(active, play_name) {
            ...
            if (exist && play_name.at(0) === 'r') {
                count = Caculate.combine(arr, play_name.split('')[1]).length;
            }
            return count;
        }
        ...
        value: function computeBonus(active, play_name) {
            ...
            if (play[0] === 'r') {
                ...
                if (min_active > 0) {
                    if (min_active - play[1] >= 0) {
                        ...
                        if (play[1] - 5 > 0 && active - play[1] >= 0) {
                            ...
                            min = Caculate.combine(arr, active - 5).length;
                        } else {
                ...
                if (play[1] - 5 > 0) {
                    ...
                    arr = new Array(Math.min(5 - active)).fill(0);
